...
const sections: { t: string; body: string[] }[] = [
  {
    t: "1. Общие положения",
    body: [
      "Настоящая Политика конфиденциальности и обработки персональных данных (далее — «Политика») разработана ООО «Лояльность» в соответствии с требованиями Федерального закона от 27.07.2006 № 152-ФЗ «О персональных данных» и определяет порядок обработки персональных данных пользователей сайта ООО «Лояльность» (далее — «Сайт»).",
  ...
  },
  {
    ...
    body: [
      ...
      "Для реализации прав направьте запрос на email: workdolgikh@yandex.ru. Срок ответа — до 30 календарных дней.",
    ],
  },
  {
    t: "8. Cookies",
  ...
  },
  {
    t: "10. Контакты",
    body: [
      "Оператор персональных данных: ООО «Лояльность».",
      "По всем вопросам, связанным с обработкой персональных данных: workdolgikh@yandex.ru.",
    ],
  },
];
