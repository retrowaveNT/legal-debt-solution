...
const sections: { t: string; body: string[] }[] = [
  {
    ...
    body: [
      ...
      "Настоящая Политика разработана в соответствии с требованиями Федерального закона от 27.07.2006 № 152-ФЗ «О персональных данных» и определяет порядок обработки персональных данных пользователей сайта юридической компании «Лояльность» (далее — «Сайт»).",
  ...
  },
  {
    ...
    body: [
      ...
      "Для реализации прав направьте запрос на email: privacy@loyalnost.example. Срок ответа — до 30 календарных дней.",
    ],
  },
  {
    t: "8. Cookies",
  ...
  },
  {
    ...
    body: [
      ...
      "По всем вопросам, связанным с обработкой персональных данных: privacy@loyalnost.example.",
    ],
  },
];
